    ...
    return (
        <div className='bg-white cursor-pointer w-56 h-60 rounded-lg'>
            <figure className='relative mb-2 w-full h-4/5'>
                ...
                <img className='w-full h-full object-cover rounded-lg' src='https://media.istockphoto.com/id/835148968/es/foto/rojo-auriculares-aislados.jpg?s=612x612&w=0&k=20&c=gIuKA8V-dE647piN5xgsb4BVCqzoNsC1IqMETorPDn8=' alt='headphones' />
